...
export const PERSONAS: Persona[] = [
  // women / girls
  { name: "춤추는 토끼", face: enc("woman/girl", "1kmbpd1kmbpd1kmb 3") },
  { name: "노래하는 햇살", face: enc("woman/girl", "4wzr754wzr754wzr 5") },
  { name: "사진찍는 사슴", face: enc("woman/girl", "6fq25v6fq25v6fq2 2") },
  { name: "발랄한 코스모스", face: enc("woman/girl", "8zak848zak848zak 5") },
  { name: "사랑스러운 백합", face: enc("woman/woman", "29yowa29yowa29yo 5") },
  { name: "산뜻한 봄", face: enc("woman/woman", "4wzr754wzr754wzr 4") },
  { name: "반짝이는 별", face: enc("woman/woman", "8zak848zak848zak 4") },
  { name: "다정한 별빛", face: enc("woman/woman", "ggx8izggx8izggx8 7") },
  { name: "다정한 토끼", face: enc("woman/grandma", "29yowa29yowa29yo 6") },
  { name: "정겨운 단풍", face: enc("woman/grandma", "4wzr754wzr754wzr 6") },
  // men / boys
  { name: "산책하는 강아지", face: enc("man/boy", "1kmbpd1kmbpd1kmb 4") },
  { name: "씩씩한 사슴", face: enc("man/boy", "4wzr754wzr754wzr 8") },
  { name: "재밌는 너구리", face: enc("man/boy", "6fq25v6fq25v6fq2 3") },
  { name: "용감한 곰", face: enc("man/man", "29yowa29yowa29yo 7") },
  { name: "그림그리는 곰", face: enc("man/man", "2yfg492yfg492yfg 5") },
  { name: "신나는 펭귄", face: enc("man/man", "4wzr754wzr754wzr 7") },
  { name: "글쓰는 부엉이", face: enc("man/man", "8zak848zak848zak 7") },
  { name: "빛나는 해바라기", face: enc("man/man", "ggx8izggx8izggx8 10") },
  { name: "책읽는 알파카", face: enc("man/grandfa", "29yowa29yowa29yo 8") },
  { name: "씩씩한 늑대", face: enc("man/grandfa", "4wzr754wzr754wzr 9") },
];
