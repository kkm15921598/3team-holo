...
const QA_ITEMS: QaItem[] = [
  ...
  },
  {
    id: "qa-meet-4",
    category: "모임/게시판",
    question: "지난(종료된) 모임은 어떻게 되나요?",
    answer:
      "모임 일정 날짜가 지나면 자동으로 \"종료\" 로 표시되고 더 이상 새로 참여할 수 없어요. 홈 추천과 지도에서는 빠지지만, 게시판과 마이페이지 \"모임 참여\" 에서 기록으로 확인할 수 있어요. 종료된 모임에 참여했던 분은 별점과 한 줄 후기를 남길 수 있어요.",
  },
  {
    id: "qa-point-1",
    category: "포인트",
  ...
  },
  {
    id: "qa-etc-3",
    category: "기타",
    question: "홈 화면의 \"동네 한 줄 소식\" 은 무엇인가요?",
    answer:
      "게시글을 쓰기엔 부담스러운 짧은 동네 소식(예: \"○○빵집 마감 세일\")을 한 줄로 가볍게 남기는 기능이에요. 홈 상단에 이웃들의 소식이 흐르고, 다른 사람의 소식은 24시간 뒤 사라지지만 내가 남긴 소식은 계속 유지돼요.",
  },
];
